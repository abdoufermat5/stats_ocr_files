...
if not os.path.exists(log_dir):
    os.makedirs(log_dir)
if not os.path.isfile(os.path.join(log_dir, "ocr_app.log")):
    open(os.path.join(log_dir, "ocr_app.log"), "w").close()


# Créez un gestionnaire de fichiers pour enregistrer les logs dans un fichier
file_handler = TimedRotatingFileHandler(os.path.join(log_dir, "ocr_app.log"), when="midnight")
